<template>
    <div class="containner">
        <div  class="form-content">
            <h3 class="title">我的合约</h3>
            <div class="msg-centent">
                当你收到确认航空公司出票后，请确认合约，如果有任何问题请在出票后24小时内提出仲裁，并提供仲裁依据。
            </div>
            <div class="info-wrap">
                ...
                <div class="btn-wrap">
                    <van-button round size="small" type="danger" @click="onSubmit">需要仲裁</van-button>
                    <van-button round size="small" type="primary" @click="onSubmit">确认出票</van-button>
                </div>
            </div>
